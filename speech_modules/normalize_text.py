...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, help="input directory containing wav files", default = 'speech_modules/data/original_data/SLU/train_final_20230919.jsonl')
    parser.add_argument('--output_dir', type=str,  help="output directory containing augmented files", default = 'speech_modules/data/original_data/train_normalized_20230919.jsonl')
