...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, help="Model checkpoint",
                        default='speech_modules/checkpoint/best-wav2vec2-ckpt')
    parser.add_argument('--test_dir', type=str, help="Directory of test audio files",
                        default='speech_modules/data/original_data/public_test/')
